...
<head>
    ...
    <style>
        :root {
            <?php if ($hero_image): ?>
            --hero-bg-image: url('<?php echo $hero_image; ?>');
            <?php endif; ?>
        }
    </style>
</head>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <div class="school-badge animate-fadeIn">📚 Established Excellence Since 1990</div>
            <h1 class="animate-fadeInUp"><?php echo htmlspecialchars($hero_title); ?></h1>
            <p class="animate-fadeInUp stagger-1"><?php echo htmlspecialchars($hero_subtitle); ?></p>
    ...
    <section class="bg-white">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title">Why Choose Sekgwari?</h2>
